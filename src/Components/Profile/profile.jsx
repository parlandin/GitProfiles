...
import BoxInfoUser from "../../BoxInfoUser/boxInfoUsr"
        ...
        <Style.Wrapper>
            <Style.WrapperTemp>
                ...
                <Style.WrapperInfos>
                    ...
                    <Style.InfoBios>{
                        githubState.user.bio ? githubState.user.bio : "doesn't have bios"}</Style.InfoBios>
                </Style.WrapperInfos>

            </Style.WrapperTemp>

            <Style.WrapperStatus>
                <Style.InfoDate>Join in: {new Date(githubState.user.created_at).toLocaleString('pt-BR').substring(0,10)}</Style.InfoDate>
